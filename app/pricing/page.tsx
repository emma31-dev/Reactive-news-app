...
const tiers = [
  {
    ...
    features: [
      ...
      'All event categories (Whale Watch, Governance, Security, Market)',
      'Save up to 10 articles for later',
      'Basic filtering and pagination (15 items/page)',
      'User reviews and ratings',
      'Up to 90 cached events',
  ...
  },
  {
    ...
    features: [
      ...
      'Save unlimited articles (no 10-item limit)',
  ...
  },
  {
    ...
    features: [
      ...
      'Dedicated validator node access',
